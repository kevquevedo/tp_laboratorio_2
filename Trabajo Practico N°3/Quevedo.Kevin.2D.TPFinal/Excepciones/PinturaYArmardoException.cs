...
{
    public class PinturaYArmardoException : Exception
    {
        /// <summary>
        /// Constructor publico sin parametros, el cual posee un mensaje por defecto.
        /// </summary>
        public PinturaYArmardoException()
            : base("No se pudo pintar y armar el mueble.")
        {
        ...
        public PinturaYArmardoException(string mensaje)
            : this(mensaje, null)
        {
        ...
        public PinturaYArmardoException(string mensaje, Exception innerException)
