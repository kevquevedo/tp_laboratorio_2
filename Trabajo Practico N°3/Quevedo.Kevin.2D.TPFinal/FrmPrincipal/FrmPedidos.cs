...
namespace Formularios
{
    public partial class FrmPedidos : Form
    {
        ...
        private void ImprimirPedido_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    sb.Append(item.InformacionPedido());
                    sb.AppendLine("------------------------");
                }
                archivador.Guardar(sb.ToString());
        ...
        private void btnSerializarXML_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("El archivo se serializó a XML con exito!");
            }
             catch (ArgumentNullException)
            {
                MessageBox.Show("La ruta de acceso es null.", "Atención!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void btnSerializarBinario_Click(object sender, EventArgs e)
        {
            try
            {
                string ruta = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + @"\Archivo-Kevin-Quevedo.bin";
                SerializadorBinario<Pedidos> archivoSerializable = new SerializadorBinario<Pedidos>(ruta);

                archivoSerializable.Guardar(fabrica1.ListaPedidos);
                MessageBox.Show("El archivo se serializó a Binario con exito!");
        ...
        private void btnDeserealizarBinario_Click(object sender, EventArgs e)
        {
            try
            {
                string ruta = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + @"\Archivo-Kevin-Quevedo.bin";
                ...
                MessageBox.Show("El archivo se deserializó de Binario con exito!");
                StringBuilder sb = new StringBuilder();
                foreach (Pedidos item in pedidos)
                {
                    sb.AppendLine(item.InformacionPedido());
