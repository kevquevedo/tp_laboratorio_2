...
namespace Productos
{
    ...
    public abstract class Muebles
    {
        ...
        /// <summary>
        /// Propiedad de lectura/escritura que indica si se encuentra lijado un Mueble.
        /// </summary>
        public bool EstaLijado 
        {
            get 
            {
                return this.lijado;
        ...
        /// <summary>
        /// Propiedad de lectura/escritura que indica si se encuentra pintado un Mueble.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            if (!this.Estado)
            {
                sb.Append($"Estado: En proceso.");
            }
            else
            {
                sb.Append($"Estado: Terminado.");
            }
