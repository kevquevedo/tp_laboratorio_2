...
namespace Fabrica
{
        ...
        where U : Pedidos, new()
    {
        ...
        /// <summary>
        /// Propiedad de lectura/escritura que retorna y asigna la lista de Pedidos.
        /// </summary>
        ...
        public bool Recortar(T mueble)
        {
            ...
            if(!(mueble is null))
            {
                if ((this.PlanchasMadera - mueble.ConsumoMadera) >= 0 &&
                     mueble.Estado == "Sin Tratamiento")
                {
                    Thread.Sleep(3000);
                    this.PlanchasMadera -= mueble.ConsumoMadera;
                    mueble.Estado = "Recortado";
                    retorno = true;
                }
                else
                {
        ...
        {
            bool retorno = false;
            if(mueble.Estado == "Lijado")
            {
                Thread.Sleep(3000);
                mueble.Estado = "Pintado";
                retorno = true;
            }
            else
            {
        ...
        {
            bool retorno = false;   
            if (mueble.Estado == "Pintado")
            {
                Thread.Sleep(3000);
                mueble.Estado = "Terminado";
                retorno = true;
            }
            else
            {
